<template>
	<div class="home">
		...
		<div class="hidden-xs-only">
			<div
				style="position: relative;z-index: 1;height: 350px;font-size: 15px;color: #fff;background: url('../../assets/all/banner.jpg');">
		...
		<div class="hidden-md-and-up">
			<div
				style="position: relative;z-index: 1;height: 120px;font-size: 15px;color: #fff;background: url('../../assets/all/banner.jpg');">
