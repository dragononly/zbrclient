<template>
	<div class="home">
		...
		<div class="hidden-xs-only">
			<div
				style="position: relative;z-index: 1;height: 350px;font-size: 15px;color: #fff;background: url('http://aliyun.moono.vip/cloud/zbr/二级页面/新闻/banner.jpg');">
		...
		<div class="hidden-md-and-up">
			<div
				style="position: relative;z-index: 1;height: 120px;font-size: 15px;color: #fff;background: url('http://aliyun.moono.vip/cloud/zbr/二级页面/新闻/banner.jpg');">
